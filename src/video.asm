...
; load_bg_full_screen()       hl=map data ptr   b=width c=height    d=toggle high bit for 8800
load_bg_full_screen:
    ld      a, d
    ld      [high_bit_flag], a
    ld      a, b
...
.next_x
    WAIT_SCREEN_BLANK ; destroys a & c
    
    ; load position registers
    ld      a, [bg_pos_x]
    ld      b, a
    ld      a, [bg_pos_y]
    ld      c, a
